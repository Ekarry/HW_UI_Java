...
public class TestKudaGo {
    ...
    void LogIn() {
        ...
        assertThat(userZone.get(0), hasText("Ekarry"));
    ...
    void ButtonDatePicker() {
        ...
        driver.findElement(By.xpath("//div[@aria-label='чт 11 нояб. 2021 г.']")).click();
        ...
        assertThat(datePicker.get(0).getText(), containsString("11 ноября"));
    }
