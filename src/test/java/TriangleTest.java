...
public class TriangleTest {
    ...
    class UnitTests {
        ...
        @Test
        @DisplayName("Треугольник нельзя создать со нулевыми значениями сторон")
        void zeroAreaTriangleCanNotBeCreated() {
            assertThrows(IllegalArgumentException.class,() -> new TriangleApp(0,0,0));
        }

        @Test
        @DisplayName("Треугольник нельзя создать c отрицательными значениями сторон")
