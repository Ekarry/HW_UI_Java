...
public class ProjectCreating {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.name("crm_project[name]")).sendKeys("Тестовый Проект 202111");

        driver.findElement(By.xpath("//span[@class='select2-arrow']/..")).click();
        driver.findElement(By.xpath("//input[@class='select2-input select2-focused']")).sendKeys("Тестит тест");
